...
void MX_FREERTOS_Init(void) {
  ...
  MotorControlTasHandle = osThreadNew(StartTask02, NULL, &MotorControlTas_attributes);

  /* creation of UART_Task */
  UART_TaskHandle = osThreadNew(StartTask03, NULL, &UART_Task_attributes);

  /* creation of ServoControlTas */
  ServoControlTasHandle = osThreadNew(StartTask04, NULL, &ServoControlTas_attributes);
